            ...
            <div class="position-relative z-index-5">
                <div class="row">
                    ...
                    <div class="col-xl-6 col-xxl-5 col-12 col-sm-6 col-lg-6">
                        <div
                            ...
                            <div class="col-sm-8 col-md-6 col-xl-9">
                                ...
                                <p class="fs-7 fw-bolder" style="text-align: center">Account's Management system</p>
                                <div class="login-page">
                                    <div class="">
                                        ...
                                        <form method="POST" action="{{ route('login/process') }}" class="login-form">
                                            ...
                                            <button class="btn btn-primary btn_login w-100 py-8 mb-4 rounded-2"><i
                                                    class="fad fa-sign-in-alt"></i> Sign In
                                            </button>
                    ...
                    <div class="col-md-12 welcome-footer text-center animated fadeInUp" style="animation-delay:0.8s;">
                        <a href="http://xenottabyte.in/" target="_blank">
                            <h1 class=" text-footer-1">Xenottabyte Services Pvt. Ltd</h1>
                        </a>
                    </div>
                </div>
            </div>
