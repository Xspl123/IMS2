            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        ...
                        {{ Form::select('currency', ['INR' => '₹ INR', 'EUR' => '€ EUR', 'USD' => '$ USD'], $settings['currency'], ['class' => 'form-control']) }}
                    </div>
                            <div class="form-group input-row">
                    ...
                    'pagination_size': {
                        ...
                        'validate': function (field, event) {
                            ...
                            if (!pagination_pattern.test(field.val())) {
                                throw "A pagination must be an integer.";
                            }
                    ...
                    'priority_size': {
                        ...
                        'validate': function (field, event) {
                            ...
                            if (!priority_pattern.test(field.val())) {
                                throw "A priority must be an integer.";
                            }
