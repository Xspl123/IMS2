        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            {{ Form::open(['route' => 'processStoreVendors']) }}
                            ...
                            <div class="form-group input-row">
                                ...
                                <div class="input-group">
                                    ...
                                    {{ Form::text('gst_number', null, ['class' => 'form-control', 'placeholder' => App\Traits\Language::getMessage('messages.InputText')]) }}
                                </div>
                            </div>
